...
////////////////// OPTION LAYOUT DEFINITION /////////////////////
   ...
   yaap::OptionArg<std::string,1>* inputOpt = parser.AddOptionArg<std::string,1>( 'i', "Input file (.vti)");
   ...
   yaap::OptionArg<double,3>* spacingOpt = parser.AddOptionArg<double,3>( 's', "Spacing (size of pixel): x y z (double)");
   // Add an option of type "-o filename"
   yaap::OptionArg<std::string,1>* outputOpt = parser.AddOptionArg<std::string,1>( 'o', "Output file (.vti)");
